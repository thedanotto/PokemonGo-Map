...
function initMap() {
    ...
    map = new google.maps.Map(document.getElementById('map'), {
        ...
        mapTypeControlOptions: {
            ...
            mapTypeIds: [google.maps.MapTypeId.ROADMAP, google.maps.MapTypeId.SATELLITE, 'dark_style', 'style_light2', 'style_pgo']
        }
    });
...
function clearStaleMarkers() {
    $.each(map_pokemons, function (key, value) {
        ...
        if (map_pokemons[key]['disappear_time'] < new Date().getTime() || excludedPokemon.indexOf(map_pokemons[key]['pokemon_id']) >= 0) {
